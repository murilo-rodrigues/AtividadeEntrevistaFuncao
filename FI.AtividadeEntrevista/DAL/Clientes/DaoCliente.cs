...
namespace FI.AtividadeEntrevista.DAL
{
    ...
    internal class DaoCliente : AcessoDados
    {
        ...
        public void AdicionarBeneficiarios(long idCliente, List<Beneficiario> beneficiarios)
        {
            ...
            // Chama a procedure usando o método Executar
            //A Procedure avalia quais beneficiários já existem e adiciona apenas os novos, fazendo assim as alterações nos existentes.
            //Havia outras maneiras de realizar esse processo, porém dada a estrutura do teste resolvi deixar a lógica na procedure mesmo.
